...
/*
int ll_map(LinkedList* this, void* imprimirElemento(void*))
{
	int i;
	void* elemento;

	if (this != NULL && imprimirElemento != NULL)
	{
		for(i=0; i<ll_len(this); i++)
		{
...
void imprimirElemento(void* pElemento)
{
int returnAux
	if (pElemento != NULL)
}

void* ll_filter(LinkedList* this, int elEmpleadoTrabajaMasDe8Horas)
{
	ll_newLinkedList(this);
	int i;
...
int elEmpleadoTrabajaMasDe8Horas(void* pElemento)
{
